...
function Form() {
  return (
    <>
      <div className="min-h-screen  sm:flex sm:flex-row  justify-center bg-amber-300 lg:p-50 ms:p-10  rounded-3xl shadow-xl xl:m-20 m-6  ">
        ...
        <div className="flex justify-center self-center z-10 w-96 sm:w-full">
